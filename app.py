...
def get_item_definitions():
    return [
        ...
        {"id": "unlock_all_cats", "type": "unlock_all_cats", "name": "모든 고양이 언락", "icon": "🐱", "category": "고양이추가", "price": 0, "vip": True},
        {"id": "unlock_all_obtainable", "type": "unlock_all_obtainable_cats", "name": "획득 가능한 고양이 언락", "icon": "🐾", "category": "고양이추가", "price": 0, "vip": True},
        {"id": "unlock_cat_id", "type": "unlock_cat", "name": "특정 고양이 ID 언락", "icon": "🔍", "category": "고양이추가", "price": 0, "needs_cat_id": True, "vip": True},
        {"id": "true_form_all", "type": "true_form_all_cats", "name": "모든 고양이 3진화", "icon": "⭐", "category": "고양이진화", "price": 0, "vip": True},
        {"id": "true_form_cat_id", "type": "true_form_cat", "name": "특정 고양이 3진화", "icon": "🌟", "category": "고양이진화", "price": 0, "needs_cat_id": True, "vip": True},
        {"id": "fourth_form_all", "type": "fourth_form_all_cats", "name": "모든 고양이 4진화", "icon": "💫", "category": "고양이진화", "price": 0, "vip": True},
        {"id": "fourth_form_cat_id", "type": "fourth_form_cat", "name": "특정 고양이 4진화", "icon": "✨", "category": "고양이진화", "price": 0, "needs_cat_id": True, "vip": True},
        {"id": "upgrade_all_max", "type": "upgrade_all_cats_max", "name": "모든 고양이 만렙 강화", "icon": "🔝", "category": "고양이강화", "price": 0, "vip": True},
        {"id": "upgrade_cat_max_id", "type": "upgrade_cat_max", "name": "특정 고양이 만렙 강화", "icon": "📈", "category": "고양이강화", "price": 0, "needs_cat_id": True, "vip": True},
        {"id": "upgrade_cat_custom", "type": "upgrade_cat", "name": "특정 고양이 레벨 지정 강화", "icon": "⚙️", "category": "고양이강화", "price": 0, "needs_cat_id": True, "needs_levels": True, "vip": True},
        {"id": "talents_all_max", "type": "upgrade_talents_all_cats", "name": "모든 고양이 특훈 만렙", "icon": "🎯", "category": "고양이특훈", "price": 0, "vip": True},
        {"id": "talents_cat_max_id", "type": "upgrade_talents_cat", "name": "특정 고양이 특훈 만렙", "icon": "🏹", "category": "고양이특훈", "price": 0, "needs_cat_id": True, "vip": True},
        {"id": "cat_guide_all", "type": "unlock_all_cat_guide", "name": "모든 고양이 도감 등록", "icon": "📖", "category": "고양이도감", "price": 0, "vip": True},
        {"id": "cat_guide_cat_id", "type": "unlock_cat_guide_cat", "name": "특정 고양이 도감 등록", "icon": "📚", "category": "고양이도감", "price": 0, "needs_cat_id": True, "vip": True},
        {"id": "catfood_custom", "type": "catfood", "name": "통조림 커스텀", "icon": "🥫", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "xp_custom", "type": "xp", "name": "XP 커스텀", "icon": "✨", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "rare_ticket_custom", "type": "rare_ticket", "name": "레어티켓 커스텀", "icon": "🎟️", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "legend_ticket_custom", "type": "legend_ticket", "name": "레전드티켓 커스텀", "icon": "🌟", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "platinum_ticket_custom", "type": "platinum_ticket", "name": "플래티넘티켓 커스텀", "icon": "💎", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "normal_ticket_custom", "type": "normal_ticket", "name": "노멀티켓 커스텀", "icon": "🎫", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "platinum_shard_custom", "type": "platinum_shard", "name": "플래티넘조각 커스텀", "icon": "🔷", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "leadership_custom", "type": "leadership", "name": "리더십 커스텀", "icon": "⚡", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "np_custom", "type": "np", "name": "NP 커스텀", "icon": "🧬", "category": "커스텀", "price": 0, "needs_custom_amount": True, "vip": True},
        {"id": "user_rank_calc", "type": "user_rank", "name": "유저랭크 재계산", "icon": "📊", "category": "기타기능", "price": 0, "vip": True},
        {"id": "unlock_equip", "type": "unlock_equip", "name": "장비 메뉴 해제", "icon": "🔓", "category": "기타기능", "price": 0, "vip": True},
        # ===== BCSFE 스테이지 클리어 (VIP 전용) =====
        {"id": "clear_chapter_1", "type": "clear_stages", "name": "제1장 클리어", "icon": "🌍", "category": "스테이지", "price": 0, "chapter_id": 1, "vip_only": True, "vip": True},
        {"id": "clear_chapter_2", "type": "clear_stages", "name": "제2장 클리어", "icon": "🌍", "category": "스테이지", "price": 0, "chapter_id": 2, "vip_only": True, "vip": True},
        {"id": "clear_chapter_3", "type": "clear_stages", "name": "제3장 클리어", "icon": "🌍", "category": "스테이지", "price": 0, "chapter_id": 3, "vip_only": True, "vip": True},
        {"id": "clear_chapter_4", "type": "clear_stages", "name": "미래편 제1장 클리어", "icon": "🚀", "category": "스테이지", "price": 0, "chapter_id": 4, "vip_only": True, "vip": True},
        {"id": "clear_chapter_5", "type": "clear_stages", "name": "미래편 제2장 클리어", "icon": "🚀", "category": "스테이지", "price": 0, "chapter_id": 5, "vip_only": True, "vip": True},
        {"id": "clear_chapter_6", "type": "clear_stages", "name": "미래편 제3장 클리어", "icon": "🚀", "category": "스테이지", "price": 0, "chapter_id": 6, "vip_only": True, "vip": True},
        {"id": "clear_chapter_7", "type": "clear_stages", "name": "우주편 제1장 클리어", "icon": "🌌", "category": "스테이지", "price": 0, "chapter_id": 7, "vip_only": True, "vip": True},
        {"id": "clear_chapter_8", "type": "clear_stages", "name": "우주편 제2장 클리어", "icon": "🌌", "category": "스테이지", "price": 0, "chapter_id": 8, "vip_only": True, "vip": True},
        {"id": "clear_chapter_9", "type": "clear_stages", "name": "우주편 제3장 클리어", "icon": "🌌", "category": "스테이지", "price": 0, "chapter_id": 9, "vip_only": True, "vip": True},
        {"id": "clear_all_stages", "type": "clear_all_stages", "name": "전체 스테이지 클리어", "icon": "🏆", "category": "스테이지", "price": 0, "vip_only": True, "vip": True},
    ]
